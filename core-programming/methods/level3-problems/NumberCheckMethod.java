...
public class NumberCheckMethod {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Largest: " + largestValues[0] + ", Second Largest: "
                + (largestValues[1] == Integer.MIN_VALUE ? "None" : largestValues[1]));

        int[] smallestValues = findSmallestAndSecondSmallest(digits);
        System.out.println("Smallest: " + smallestValues[0] + ", Second Smallest: "
                + (smallestValues[1] == Integer.MAX_VALUE ? "None" : smallestValues[1]));
